...
export const vi_VN = {
  ...
  messages: {
    ...
    monsterFullyHealed: '🐉 Quái vật đã hồi đầy máu và tiếp tục tấn công!',
    monsterFullyRested: '🐉 Quái vật đã hồi phục và tiếp tục săn mồi!',
    monsterRetreating: '🐉 Quái vật rút lui để hồi máu!',
    healingPointsExhausted: '⚡ Tất cả điểm hồi máu đã cạn kiệt năng lượng!',
    healingPointDepleted: '💧 Điểm hồi máu hết năng lượng - quái vật tiếp tục tấn công!',
